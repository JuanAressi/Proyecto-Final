...
Route::post('medicos/horarios', 'App\Http\Controllers\MedicosController@addNewHorarios');
Route::delete('medicos/horarios', 'App\Http\Controllers\MedicosController@deleteHorarios');
